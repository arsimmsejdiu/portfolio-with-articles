...
![AppLock Image guide!](/tech-images/applock-policy-with-intune/applocker-localpolicyeditor.png)
...
![Test-AppLockerPolicy Image guide!](/tech-images/applock-policy-with-intune/Applocker_testxml_success_allow.png)
...
![AppLockerPolicy yaml file Image guide!](/tech-images/applock-policy-with-intune/applocker-localpolicyeditor_exe.png)
...
![Miccrosoft endpoint manager Image guide!](/tech-images/applock-policy-with-intune/Intune_Applocker_Policy_EXE.png)
...
![Event Viewer Image guide!](/tech-images/applock-policy-with-intune/Blog_Applocker_2023_img1.jpg)
